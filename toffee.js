...
(function() {
  ...
  view = (function() {
    ...
    view.prototype.run = function(options) {
      ...
      */
      ...
      if (this.compileError) {
        console.log(this.compileError.converted_msg);
        return [this._prettyPrintCompileError(), ""];
      } else {
        try {
          sandbox = {
    ...
    view.prototype._prettyPrintCompileError = function() {
      ...
      if (!this.compileError) {
        ...
        res += "<b>" + this.compileError.converted_msg + "</b>";
        res += "\n  <br />--------<br />";
        res += "\n<div style=\"font-family:courier new;font-size:10pt;color:#900;\">";
        txt_lines = this.txt.split('\n');
        for (i = _i = _ref = this.compileError.toffee_line_range[0] - 3, _ref1 = this.compileError.toffee_line_range[1] + 1; _ref <= _ref1 ? _i < _ref1 : _i > _ref1; i = _ref <= _ref1 ? ++_i : --_i) {
          if ((i < 0) || i > txt_lines.length - 1) continue;
    ...
    view.prototype._generateCompileError = function(e, src) {
      /*
      ...
      */
      ...
      var after, after_matches, before, msg, new_msg, prev_matches, res, search, src_lines, txt_lines;
      msg = e.message;
      res = {
        src_line: 0,
    ...
    view.prototype._toJavaScript = function() {
      ...
      if (!(this.javaScript != null)) {
        ...
        try {
          ...
          this._generateCompileError(e, c);
        }
      }
