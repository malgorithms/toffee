...
(function() {
  var TAB_SPACES, coffee, errorHandler, lexer, parser, states, view, vm;
  ...
  view = (function() {
    ...
    view.prototype._interpolateToffee = function(str) {
      var indent, p, particles, parts, piece, res, token, _i, _j, _len, _len1, _ref;
      this.lexer.tokenize('');
      parts = this.lexer.interpolateString(str);
      res = [];
    ...
    view.prototype._rebuildInterpolatedString = function(interp) {
      var part, res, _i, _len;
      res = "";
      for (_i = 0, _len = interp.length; _i < _len; _i++) {
        part = interp[_i];
        if (part[0] === "TOKENS") {
          res += "\#{escape(" + part[1] + ")}";
        } else {
          res += this._escapeForStr(part[1]);
        }
      }
      console.log(res);
      return res;
    ...
    view.prototype._toCoffeeRecurse = function(obj, indent_level, indent_baseline) {
      var c, delta, i, i_delta, ind, item, lbreak, line, lines, r_str, res, s, t_int, temp_indent_level, zone_baseline, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      res = "";
      i_delta = 0;
      switch (obj[0]) {
        ...
        case "TOFFEE":
          ...
          t_int = this._interpolateToffee(obj[1]);
          r_str = this._rebuildInterpolatedString(t_int);
          lines = r_str.split("\n");
