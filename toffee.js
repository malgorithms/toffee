...
(function() {
  ...
  error = (function() {
    ...
    function error(view, err_type, e) {
      this.errType = err_type;
      this.view = view;
      this.e = e;
      this.toffeeSrc = view.txt;
      switch (this.errType) {
        case errorTypes.TOFFEE_COMPILE:
    ...
    error.prototype.getConvertedError = function() {
      /*
    ...
    error.prototype.getPrettyPrintError = function() {
      /*
    ...
    error.prototype._lineRangeToPhrase = function(lrange) {
    ...
    error.prototype._extractOffensiveLineNo = function(msg, rxx) {
      var m;
      m = msg.match(rxx);
    ...
    error.prototype._convertOffensiveLineToToffeeRange = function(lineno) {
      /*
