...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[2,7],$V1=[1,8],$V2=[1,7],$V3=[1,9],$V4=[5,15],$V5=[1,15],$V6=[2,19],$V7=[1,20],$V8=[11,12,13,14,15,16],$V9=[5,9,12,13,14,15,16],$Va=[5,9,12,15,16];
...
switch (yystate) {
case 1:
 this.$ = ["TOFFEE_ZONE", $$[$0-1]]; return this.$;
break;
case 2: case 16:
 this.$ = [$$[$0]]; 
break;
case 3: case 17:
 this.$ = $$[$0]; $$[$0].splice(0,0,$$[$0-2],$$[$0-1]); 
break;
case 4: case 18:
 this.$ = $$[$0]; $$[$0].splice(0,0,$$[$0-1]); 
break;
case 5:
 this.$ = $$[$0]; $$[$0].splice(0,0,$$[$0-2]); 
break;
case 6:
 this.$ = $$[$0];  
break;
...
break;
case 15:
 this.$ = ["COFFEE_ZONE", $$[$0-1]]; 
break;
case 20:
 this.$ = ["TOFFEE_ZONE", $$[$0-1]]; 
break;
case 21:
 this.$ = ["TOFFEE", $$[$0][0], $$[$0][1] ]; 
break;
