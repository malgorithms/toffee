  ...
  toffeeError = (function() {
    ...
    toffeeError.prototype.getPrettyPrint = function() {
      ...
      */
      ...
      res += "<div style=\"line-height:1.05em;border:1px solid #999;margin:10px;padding:10px;background-color:#fff;position:fixed;top:0;left:0;max-width:90%;z-index:9999;max-height:90%;overflow:scroll;\">\n  \n<pre>" + header + "</pre>\n  \n<hr />\n  \n<div style=\"font-family:courier new;font-size:10pt;color:#900;width:100%;\">        ";
      if ((_ref = cerr.stack) != null ? _ref.length : void 0) {
