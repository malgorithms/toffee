...
(function() {
  var TAB_SPACES, coffee, e, errorHandler, errorTypes, getBundleHeaders, getCommonHeaders, getCommonHeadersJs, minimizeJs, parser, spaces, states, tabs, toffeeError, util, utils, view, vm, _ref, _ref1;
  ...
  tabs = function(n) {
    ...
    return ((function() {
      ...
      _results = [];
      for (i = _i = 0; 0 <= n ? _i < n : _i > n; i = 0 <= n ? ++_i : --_i) {
        _results.push(spaces(TAB_SPACES));
      }
      return _results;
    })()).join("");
  };
  ...
  view = (function() {
    function view(txt, options) {
      ...
      */
      ...
      this.error = null;
      if (options.cb) {
        this._prepAsync(txt, options.ctx, (function() {
    ...
    view.prototype.run = function(options, ctx) {
      ...
      */
      ...
      var fun, line, pair, res, txt, _i, _len, _ref2;
      ctx = ctx || vm.createContext({});
      fun = this._toFun(ctx);
      res = null;
      if (!this.error) {
    ...
    view.prototype._snippetHasEscapeOverride = function(str) {
      ...
      _ref2 = ['print', ' snippet', 'load', 'partial', 'raw', 'html', 'json', '__toffee.raw', '__toffee.html', '__toffee.json', 'JSON.stringify'];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        token = _ref2[_i];
