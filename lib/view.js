...
(function() {
  ...
  getCommonHeaders = function(include_bundle_headers) {
    /*
  ...
  getCommonHeadersJs = function(include_bundle_headers, minimize) {
    var ch, js;
  ...
  view = (function() {
    ...
    view.prototype.run = function(options) {
      ...
      */
      ...
      if (this.error) {
        console.log("PRETTY LOG ERRORS: " + this.prettyLogErrors);
