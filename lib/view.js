    ...
    view.prototype.toCoffee = function() {
      ...
      if (!(this.coffeeScript != null)) {
        ...
        if (!this.error) {
          ...
          try {
            res += this._toCoffeeRecurse(tobj, TAB_SPACES + 2, 0, {})[0];
