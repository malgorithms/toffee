...
yy: {},
symbols_: {"error":2,"starter":3,"cojo_zone":4,"EOF":5,"cojo_code":6,"flip_to_coffee":7,"flip_to__cojocomment":8,"START_COJO_COMMENT":9,"code":10,"END_COJO_COMMENT":11,"START_COFFEE":12,"coffee_zone":13,"END_COFFEE":14,"coffee_code":15,"flip_to_cojo":16,"START_COJO":17,"END_COJO":18,"START_INDENTED_COJO":19,"CODE":20,"$accept":0,"$end":1},
...
(function() {
  ...
  engine = (function() {
    ...
    engine.prototype._fn_include = function(fname, lvars, realpath, options) {
      ...
      if (options.__cojo.state === states.COFFEE) {
    ...
    engine.prototype._fn_print = function(txt, options) {
      return options.__cojo.out.push(txt);
    };
